...
app.post("/diagnose", upload.single('image'), async (req, res) => {
    ...
    try {
        ...
        res.redirect(`/results.html?class=${className}&description=${description}&symptoms=${symptoms}&med1=${med1}&med2=${med2}&med3=${med3}&dimg=${dimg}&med1p=${med1p}&med2p=${med2p}&med3p=${med3p}`);
    } catch (error) {
